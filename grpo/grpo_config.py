...
@dataclass
class MaskGRPOConfig(TrainingArguments):
    r"""
    ...
    max_steps: Optional[int] = field(
        default=0,
        metadata={"help": "to align with conventional settings, as either the max_steps or dataset.__len__ has to be specified"},
    )
    ...
    vq_model_path: str = field(
        default="/data/models/magvitv2",
    )
    ...
    pref_reward: bool = field(
        default=False,
        metadata={"help": "Whether to use ranked reward instead of original."},
    )
    version: Optional["str"] = field(
        default="d1",
        metadata={"help": "get logp method."},
    )
    mean_method: Optional["str"] = field(
        default="grpo",
        metadata={"help": "how to calculate the loss and clip?."},
    )
    min_mask_rate: float = field(
        default=0.3,
        metadata={"help": "Minimum mask rate in UniGRPO"},
    )
    model_type: Optional["str"] = field(
        default="mmada",
        metadata={"help": "model, mmada or dimoo."},
    )
